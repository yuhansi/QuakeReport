...
public final class QueryUtils {
    /* Sample JSON response from a USGS query */
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            // Create a JSONObject for the SAMPLE_JSON_RESPONSE string
            ...
            for(int i = 0; i < earthquakeArray.length(); i++) {
                ...
                // Create a new Earthquake object with the magnitude, location and time got from
                // the JSON response
